...
const ModalHeader = (props: HTMLAttributes<HTMLDivElement>) => (
  <div {...props} className={cn('flex flex-col space-y-2 text-center sm:text-left', props.className)} />
)

const ModalFooter = (props: HTMLAttributes<HTMLDivElement>) => (
  <div {...props} className={cn('flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2', props.className)} />
)

const ModalTitle = (props: DialogPrimitive.DialogTitleProps) => (
  <DialogPrimitive.Title {...props} className={cn('text-foreground text-lg font-semibold', props.className)} />
)

const ModalDescription = (props: DialogPrimitive.DialogDescriptionProps) => (
  <DialogPrimitive.Description {...props} className={cn('text-muted-foreground text-sm', props.className)} />
)
